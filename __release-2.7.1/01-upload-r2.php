<?php
/**
 * Step 1 of 2 — upload the verified v2.7.1 ZIP to R2 and read it back.
 *
...
$KEY    = 'page-blocks-builder-v2.7.1.zip';         // bucket-root key, FluentCart's own convention
$BUCKET = 'gauravtiwari-org-fluentcart';
$LOCAL  = getenv( 'HOME' ) . '/pbb-release-staging/pbb-2.7.1.zip';

// The published GitHub asset, verified locally and again after transfer.
$EXPECT_SIZE = 138023;
$EXPECT_SHA  = '070810b83f83d0e5d1a55c71d030ab29eed7e46ad0f9b49175cf22c3392fb2f9';

<?php
/**
 * Step 2 of 2 — point the FluentCart updater at v2.7.5.
 *
...
$PREV_VER   = '2.7.4';
$PREV_FILE  = 258;
$KEY        = 'page-blocks-builder-v2.7.5.zip';
$BUCKET     = 'gauravtiwari-org-fluentcart';
$SIZE       = 169799;

$CHANGELOG = '<h4>2.7.5</h4><ul>'
	. '<li>Fixed: the section panel disappeared off the right edge once the AI assistant had filled the code editors. The builder had grown wider than the window; it now fits from 1920px down to 1000px with the panel fully visible.</li>'
	. '<li>Import in Page Settings is two buttons, add or replace, instead of one dialog whose Cancel meant "replace everything". Only replace confirms, and it says what it is about to remove.</li>'
	. '<li>Page Settings shows what is on the page, reports results inline instead of through browser alerts, and stays open while you work. Exports are named after the page.</li>'
	. '<li>The AI model list keeps only the GPT-5.6 family: Sol, Terra and Luna.</li>'
	. '</ul>';
...
$ok   = ! is_wp_error( $resp ) && (int) wp_remote_retrieve_response_code( $resp ) === 200
	...
	&& hash_file( 'sha256', $tmp ) === 'd3cae211edfd7865bfe041918792dd22a839ad3ecf4c4d78e3d66017ccca687d';
@unlink( $tmp );
if ( ! $ok ) {

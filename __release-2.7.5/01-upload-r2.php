<?php
/**
 * Step 1 of 2 — upload the verified v2.7.5 ZIP to R2 and read it back.
 *
...
$KEY    = 'page-blocks-builder-v2.7.5.zip';         // bucket-root key, FluentCart's own convention
$BUCKET = 'gauravtiwari-org-fluentcart';
$LOCAL  = getenv( 'HOME' ) . '/pbb-release-staging/pbb-2.7.5.zip';

// The published GitHub asset, verified locally and again after transfer.
$EXPECT_SIZE = 169799;
$EXPECT_SHA  = 'd3cae211edfd7865bfe041918792dd22a839ad3ecf4c4d78e3d66017ccca687d';

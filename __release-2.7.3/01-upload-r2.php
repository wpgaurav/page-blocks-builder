<?php
/**
 * Step 1 of 2 — upload the verified v2.7.3 ZIP to R2 and read it back.
 *
...
$KEY    = 'page-blocks-builder-v2.7.3.zip';         // bucket-root key, FluentCart's own convention
$BUCKET = 'gauravtiwari-org-fluentcart';
$LOCAL  = getenv( 'HOME' ) . '/pbb-release-staging/pbb-2.7.3.zip';

// The published GitHub asset, verified locally and again after transfer.
$EXPECT_SIZE = 166515;
$EXPECT_SHA  = '3bd82f81d8cebb2d7db23b9cff356a8b78a520e32d6e5bc5d3e41d14872d7eb5';

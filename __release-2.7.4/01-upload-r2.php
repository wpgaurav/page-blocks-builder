<?php
/**
 * Step 1 of 2 — upload the verified v2.7.4 ZIP to R2 and read it back.
 *
...
$KEY    = 'page-blocks-builder-v2.7.4.zip';         // bucket-root key, FluentCart's own convention
$BUCKET = 'gauravtiwari-org-fluentcart';
$LOCAL  = getenv( 'HOME' ) . '/pbb-release-staging/pbb-2.7.4.zip';

// The published GitHub asset, verified locally and again after transfer.
$EXPECT_SIZE = 168050;
$EXPECT_SHA  = '0de8be8f729e2ba90cfde56046fc4814e8a27b764b6dbbe5ad7429a38d123b50';

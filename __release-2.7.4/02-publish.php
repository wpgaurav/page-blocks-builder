<?php
/**
 * Step 2 of 2 — point the FluentCart updater at v2.7.4.
 *
...
$PREV_VER   = '2.7.3';
$PREV_FILE  = 257;
$KEY        = 'page-blocks-builder-v2.7.4.zip';
$BUCKET     = 'gauravtiwari-org-fluentcart';
$SIZE       = 168050;

$CHANGELOG = '<h4>2.7.4</h4><ul>'
	. '<li>The plugin\'s two filters and four helper functions now carry the gt_ prefix, matching everything else it exposes.</li>'
	. '<li>Every previous md_-prefixed name still works, so existing snippets keep running. Each points at its replacement under WP_DEBUG while in use, and is silent otherwise.</li>'
	. '<li>No change to how pages build or render — this release is naming only.</li>'
	. '</ul>';
...
$ok   = ! is_wp_error( $resp ) && (int) wp_remote_retrieve_response_code( $resp ) === 200
	...
	&& hash_file( 'sha256', $tmp ) === '0de8be8f729e2ba90cfde56046fc4814e8a27b764b6dbbe5ad7429a38d123b50';
@unlink( $tmp );
if ( ! $ok ) {
